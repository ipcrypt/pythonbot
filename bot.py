...
TOKEN = "1423954824:AAH0cHrnClL32tb8N-q6QzurPenqLITJHSQ" # os.environ.get('TOKEN', None)
GROUPCHATID =-1001479898697 # os.environ.get('GROUPCHATID', None)
        ...
        if message.count(",") == 1 and "@" in message:
            ...
            if str(update.message.from_user.id) in registered_channels and username.lower() in registered_channels:
                ...
                if len(description.split()) > 10:
                    bot.send_message(chat_id=GROUPCHATID ,text="We don't accept description morethan 10 words @Fire_Scripts", reply_to_message_id=msg_id, disable_notification=True, timeout=50)
